    ...
    <div className="learn-more">
      ...
      <div className="learn-more-container">
        <div className="learn-more-col">
          ...
          <p className="learn-more-p">
            First of all, it will make solving difficult coding problems
            inifintely easier. Secondly, it shows you are a professional who
            cares about your craft. You will know when a situation calls for one
            tool and not another. By using the right method in the right
            situation you'll be able to avoid side-effects from your code which
            can wreak havoc when you start working on much larger, far more
        ...
        <div className="learn-more-col">
          ...
          <p className="learn-more-p">
            ...
            of JavaScript students, only an extremely small minority go about
            learning them systematically. They usually only resort to searching
            MDN when they face a challange they can't solve. And often, they
            don't know what tool can help them and lose tons of time searching.
            These lessons will install the methods into your brain so that you
            can use them on command when a situation calls for it.
          </p>
          <h4>Will knowing these methods impress interviewers?</h4>
          <p className="learn-more-p">
            Yes, of course. It shows you've put in the time to hone your craft
            and that you care about being a great problem solver. You will also
            know the how, the why, and the when of using a specific method.
            Every company will want you to write concise, declarative code that
            works. Within a month or two of learning, you'll have an edge over
            the vast majority of other students learning JavaScript.
          </p>
          <h4>
